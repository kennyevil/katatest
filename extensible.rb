...
concatenated_words.push(wd) unless concatenated_words.include?(word)
end
end
end

puts "there are #{concatenated_words.size} concatenated words and this process took #{Time.now - start_time} to run."
